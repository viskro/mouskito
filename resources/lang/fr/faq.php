...
return [
    ...
    'Toutes les réponses à vos questions sur les Sound Tags et la boutique.' => 'Toutes les réponses à vos questions sur les Sound Tags et la boutique.',
    'Nos réseaux' => 'Nos réseaux',
    'Suivez nos actualités, nouveaux sons et coulisses.' => 'Suivez nos actualités, nouveaux sons et coulisses.',
    'Le produit est-il numérique ou physique ?' => 'Le produit est-il numérique ou physique ?',
    'Nos Sound Tags sont des produits physiques NFC que vous recevez chez vous. Ils déclenchent un son lorsque vous approchez un smartphone compatible NFC.' => 'Nos Sound Tags sont des produits physiques NFC que vous recevez chez vous. Ils déclenchent un son lorsque vous approchez un smartphone compatible NFC.',
    'Comment utiliser un Sound Tag ?' => 'Comment utiliser un Sound Tag ?',
    'Il suffit d\'approcher un smartphone compatible NFC du tag. Aucun téléchargement d\'application n\'est nécessaire.' => 'Il suffit d\'approcher un smartphone compatible NFC du tag. Aucun téléchargement d\'application n\'est nécessaire.',
    'Comment recevrai-je ma commande ?' => 'Comment recevrai-je ma commande ?',
    'Nous expédions rapidement. Vous recevrez votre commande directement chez vous.' => 'Nous expédions rapidement. Vous recevrez votre commande directement chez vous.',
    'Proposez-vous des remboursements ?' => 'Proposez-vous des remboursements ?',
